...
class TestEdgeMapperToEntity(unittest.TestCase):
    def test_with_properties(self):
        ...
        dto = EdgeRequestDto(
            name='Test-Edge',
            properties=[
                PropertyDto(key='Test-Property', required=True, datatype='String')
            ],
        ...
        self.assertEqual(entity.name, 'Test-Edge')
        ...
        self.assertEqual(entity.properties[0].key, 'Test-Property')
...
class TestEdgeMapperToDto(unittest.TestCase):
    def test_with_properties(self):
        ...
        entity = Edge(
            ...
            name='Test-Edge',
            properties=[
                Property(key='Test-Property', required=True, datatype='String')
            ],
        )
        ...
        self.assertEqual(dto.name, 'Test-Edge')
        ...
        self.assertEqual(dto.properties[0].key, 'Test-Property')
